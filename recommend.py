...
INTEREST_TAG_MAP = {
    ...
    "운전": {
        "누구": ["#본인운전자", "#부부운전자", "#가족운전자", "#초보운전자", "#고령운전자", "#업무운전자", "#현대차_블루링크_가입고객", "#기아_커넥트_서비스_가입고객", "#제네시스_커넥티드_서비스_가입고객", "#KG_MOBILITY_인포콘_서비스_가입고객", "#르노코리아_서비스_가입고객", "#메르세데스벤츠_Mercedes_me_서비스_가입고객"],
        "위험": ["#교통사고처리지원금", "#벌금보장", "#변호사선임비용", "#자동차사고상해", "#중대법규위반", "#후유장해", "#면허정지", "#면허취소"],
    ...
    "주택/부동산": {
        "누구": ["#자가거주자", "#전세거주자", "#월세거주자", "#1인가구", "#소상공인", "#사업장운영자", "#다주택자"],
        "위험": ["#화재손해", "#누수배상책임", "#가재도구손해", "#도난손해", "#자연재해(풍수해·지진)", "#영업중단손실", "#가전제품고장"],
        "우선순위": ["#폭넓은보장", "#가성비_보험료"],
        "변화": ["#이사", "#내집마련"]
    },
    "반려동물": {
    ...
    "여행/레저": {
        ...
        "위험": ["#해외질병·상해", "#의료비보장", "#휴대품손해", "#항공기지연", "#배상책임", "#레저사고", "#골절", "#화상", "#상해후유장해"],
        "우선순위": ["#종합보장", "#가성비_보험료"],
        "변화": []
    },
    "건강": {
        "누구": ["#본인", "#부모님", "#부부", "#고령자", "#유병자", "#가족력보유", "#40세", "#60세"],
        "위험": ["#암진단비", "#뇌혈관질환", "#심장질환", "#입원·수술비", "#통원치료비", "#상해후유장해", "#허혈심장질환", "#항암약물치료", "#방사선치료", "#전이암", "#간병인사용", "#3대질병", "#사망", "#치매"],
